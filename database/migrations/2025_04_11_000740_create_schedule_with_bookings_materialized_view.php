...
return new class extends Migration
{
    ...
    {
        DB::connection($this->connection)->statement('DROP VIEW IF EXISTS schedule_with_bookings_mv');
        DB::connection($this->connection)->statement("
            CREATE MATERIALIZED VIEW schedule_with_bookings_mv AS
    ...
    {
        DB::connection($this->connection)->statement('DROP MATERIALIZED VIEW IF EXISTS schedule_with_bookings_mv');
    }
};
