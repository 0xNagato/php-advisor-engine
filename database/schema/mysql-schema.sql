...
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `schedule_with_bookings` AS
SELECT 1 AS `id`,
...
from (((((`date_range` `dr` join `schedule_templates` `st`
          on ((dayname(`dr`.`date`) = `st`.`day_of_week`))) left join (select `bookings`.`schedule_template_id` AS `schedule_template_id`,
                                                                       ...
                                                                       group by `bookings`.`schedule_template_id`) `b`
         on ((`st`.`id` = `b`.`schedule_template_id`))) left join `special_pricing_restaurants` `sp`
        on (((`sp`.`restaurant_id` = `st`.`restaurant_id`) and
             (`sp`.`date` = `dr`.`date`)))) left join `restaurants` `r`
       on ((`r`.`id` = `st`.`restaurant_id`))) left join `restaurant_time_slots` `rts`
      on (((`rts`.`schedule_template_id` = `st`.`id`) and (`rts`.`booking_date` = `dr`.`date`))))
        */;
...
VALUES (104, '2014_10_12_000000_create_users_table', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (105, '2014_10_12_100000_create_password_reset_tokens_table', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (106, '2014_10_12_200000_add_two_factor_columns_to_users_table', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (107, '2019_05_03_000001_create_customer_columns', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (108, '2019_05_03_000002_create_subscriptions_table', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (109, '2019_05_03_000003_create_subscription_items_table', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (110, '2019_08_19_000000_create_failed_jobs_table', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (112, '2020_05_21_100000_create_teams_table', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (113, '2020_05_21_200000_create_team_user_table', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (114, '2020_05_21_300000_create_team_invitations_table', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (115, '2024_01_10_140416_create_sessions_table', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (116, '2024_01_10_142318_create_permission_tables', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (117, '2024_01_10_144025_create_concierge_profiles_table', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (118, '2024_01_10_144047_create_restaurant_profiles_table', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (119, '2024_01_10_144057_create_customer_profiles_table', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (120, '2024_01_10_144116_create_reservations_table', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (121, '2024_01_10_144158_create_bookings_table', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (122, '2024_01_10_144217_create_payments_table', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (123, '2024_01_10_144458_add_phone_to_users', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (124, '2024_01_11_001326_create_breezy_tables', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (125, '2024_01_26_164141_remove_columns_from_restaurant_profiles', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (126, '2024_02_06_132604_mod_restaurants_table', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (127, '2024_02_09_003329_create_laragenie_table', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (128, '2024_02_09_010017_remove_and_add_columns_to_reservations', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (129, '2024_02_11_201051_rename_reservations_table_to_time_slots', 1);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (130, '2024_02_11_202717_remove_payout_percentage_from_concierge_profiles', 2);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (135, '2024_02_11_203330_modify_restaraunt_profiles', 3);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (137, '2019_12_14_000001_create_personal_access_tokens_table', 4);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (138, '2024_02_11_224354_add_fields_to_concierge_profiles', 5);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (143, '2024_02_12_114436_rename_tables', 6);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (144, '2024_02_12_121151_add_contact_names_to_restaurants', 6);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (145, '2024_02_12_150712_remove_guest_id_from_bookings', 6);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (146, '2024_02_12_152651_rename_restaurant_profile_id_to_restaurant_id_bookings', 6);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (147, '2024_02_12_182005_add_is_available_to_time_slots', 7);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (148, '2024_02_13_181011_add_schedule_to_restaurants', 8);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (149, '2024_02_13_181624_remove_time_slot_id_from_bookings', 8);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (150, '2024_02_13_191405_add_date_and_time_to_bookings', 8);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (151, '2024_02_13_215241_create_schedules_table', 8);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (152, '2019_12_22_015115_create_short_urls_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (153, '2019_12_22_015214_create_short_url_visits_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (154, '2020_02_11_224848_update_short_url_table_for_version_two_zero_zero', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (155, '2020_02_12_008432_update_short_url_visits_table_for_version_two_zero_zero', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (156, '2020_04_10_224546_update_short_url_table_for_version_three_zero_zero', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (157, '2020_04_20_009283_update_short_url_table_add_option_to_forward_query_params', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (158, '2023_06_07_000001_create_pulse_tables', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (159, '2024_02_15_215905_add_booking_fee_to_restaurants', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (160, '2024_02_15_234635_add_open_days_to_restaurants', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (161, '2024_02_16_192243_add_first_name_and_last_name_to_users', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (162, '2024_02_16_193555_add_payouts_to_restaurants', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (163, '2024_02_16_223251_add_booking_date_to_bookings', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (164, '2024_02_17_002227_add_times_to_booking', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (165, '2024_02_21_224001_add_fields_to_bookings', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (166, '2024_02_23_101108_add_stripe_payment_id_to_bookings', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (167, '2024_03_01_183514_add_payout_to_users', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (168, '2024_03_06_190233_add_charity_percentage_to_users_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (169, '2024_03_06_190900_add_earnings_to_bookings_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (170, '2024_03_06_212349_remove_payouts_from_bookings_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (171, '2024_03_06_212406_remove_payouts_from_restaurants_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (172, '2024_03_06_221618_create_partners_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (173, '2024_03_06_221756_add_partner_referal_id_to_users', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (174, '2024_03_07_214618_add_partner_fee_to_bookings_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (175, '2024_03_07_215728_add_partner_id_to_bookings', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (176, '2024_03_10_190638_change_percentage_column_in_partners_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (177, '2024_03_20_193923_add_fields_to_bookings', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (178, '2024_03_21_181419_add_contacts_to_restaurants', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (179, '2024_03_21_201656_add_restaurant_confirmed_at_to_bookings', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (180, '2024_03_21_214456_add_timezone_to_users', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (181, '2024_03_22_102512_add_resent_confirmation_to_restaurant_at_to_bookings', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (182, '2024_03_22_115320_add_secured_at_to_users', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (183, '2024_03_22_181756_add_tax_and_tax_amount_in_cents_to_bookings', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (184, '2024_03_23_155402_add_invoice_url_to_bookings', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (185, '2024_03_23_163139_remove_invoice_url_from_bookings', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (186, '2024_03_23_165123_set_auto_increment_for_id_to_be_332233_for_bookings', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (187, '2024_03_24_070629_create_special_pricing_restaurants_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (188, '2024_03_24_142016_suspend_restaurants', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (189, '2024_03_24_201255_add_non_prime_time_to_restaurants', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (190, '2024_03_27_152308_add_address_to_users', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (191, '2024_03_28_225514_add_concierge_referral_id_to_users', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (192, '2024_03_29_024650_create_cache_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (193, '2024_03_29_024734_create_jobs_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (194, '2024_03_29_205756_create_concierge_referrals_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (195, '2024_03_30_131242_add_user_id_to_concierge_referrals', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (196, '2024_03_30_172516_create_referral_earnings_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (197, '2024_03_30_195444_rename_referral_earnings_to_earnings', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (198, '2024_03_30_213746_rename_referral_type_to_type_in_earnings', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (199, '2024_03_31_013813_add_confirmed_at_to_earnings', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (200, '2024_03_31_132922_drop_unused_tables', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (201, '2024_04_01_183948_add_business_hours_to_restaurants', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (202, '2024_04_02_132855_add_day_of_week_to_schedules', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (203, '2024_04_03_105225_create_sms_response_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (204, '2024_04_08_224838_rename_concierge_id_to_referrer_id', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (205, '2024_04_09_162612_rename_table_concierge_referrals_to_referrals', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (206, '2024_04_12_115041_create_earning_errors_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (207, '2024_04_13_231643_add_prime_time_to_schedules', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (208, '2024_04_18_113532_add_party_size_and_booking_date_to_schedules', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (209, '2024_04_18_113729_add_party_sizes_to_restaurants', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (210, '2024_04_19_020315_create_announcements_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (211, '2024_04_19_044515_create_messages_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (212, '2024_04_19_131722_create_schedule_templates_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (213, '2024_04_24_033002_add_schedule_template_id_to_bookings', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (214, '2024_04_24_211805_create_view_schedules_with_bookings', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (215, '2024_04_25_202712_add_published_at_to_annoucements', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (216, '2024_04_25_230144_add_first_name_and_last_name_to_invitations', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (217, '2024_04_25_235016_add_minimum_spent_to_restaurants', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (218, '2024_04_25_235429_add_notes_to_booking', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (219, '2024_04_26_014211_update_schedules_view', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (220, '2024_04_30_134734_add_region_and_logo_path_to_restaurants', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (221, '2024_05_01_020815_add_foreign_keys_to_restaurants_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (222, '2024_05_01_041532_drop_schedules_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (223, '2024_05_01_174359_show_non_available_schedules_in_schedules_with_bookings', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (224, '2024_05_02_235406_create_authentication_log_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (225, '2024_05_03_025331_create_feedback_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (226, '2024_05_03_172843_add_notified_at_column_to_referrals_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (227, '2024_05_07_041616_add_currency_to_earnings', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (228, '2024_05_07_170929_modify_foreign_key_on_messages_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (229, '2024_05_07_193227_add_region_to_users', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (230, '2024_05_07_201419_add_region_to_announcements', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (231, '2024_05_08_113609_remove_tables_for_verbs', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (232, '2024_05_09_143808_create_devices_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (233, '2024_05_09_211039_create_user_codes_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (234, '2024_05_10_160314_add_increment_fee_to_restaurants', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (235, '2024_05_10_161902_add_non_prime_fee_to_restaurants', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (236, '2024_05_10_175404_add_no_show_to_bookings', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (237, '2024_05_13_141329_create_payments_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (238, '2024_05_13_141742_add_payment_id_to_earnings_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (239, '2024_05_13_200725_add_is_prime_to_bookings', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (240, '2024_05_14_145601_create_job_batches_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (241, '2024_05_14_145608_create_notifications_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (242, '2024_05_14_145750_create_exports_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (243, '2024_05_17_123827_add_slug_to_restaurants', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (244, '2024_05_22_123425_create_payment_items_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (245, '2024_05_22_160636_create_restaurant_time_slots_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (246, '2024_05_22_184916_update_schedule_with_bookings_view_to_incorporate_restaurant_time_slots', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (247, '2024_05_22_191952_update_schedule_with_bookings_view_to_incorporate_restaurant_time_slots_2', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (248, '2024_05_26_114829_create_special_requests_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (249, '2024_05_27_162210_add_fields_to_special_requests', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (250, '2024_05_29_144340_make_customer_email_nullable_on_special_requests', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (251, '2024_05_29_144923_add_preferences_column_to_users_table', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (252, '2024_06_05_131041_add_status_to_restaurants', 9);
INSERT INTO `migrations` (`id`, `migration`, `batch`)
VALUES (253, '2024_06_05_205417_update_schedule_with_bookings_view_to_show_all_schedules', 9);
