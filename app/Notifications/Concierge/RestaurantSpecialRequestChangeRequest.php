...
class RestaurantSpecialRequestChangeRequest extends Notification
{
    use Queueable;
    ...
    public function toSms(User $notifiable): SmsData
    {
        return new SmsData(
            ...
            text: "Special request changes have been requested from $this->restaurant. Click here for more details $this->link."
        );
    }
