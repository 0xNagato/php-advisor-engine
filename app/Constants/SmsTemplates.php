...
class SmsTemplates
{
    public const array TEMPLATES = [
        ...
        'customer_booking_received_non_prime' => '👋 Hello from PRIMA VIP! Your reservation request at {venue_name} on {booking_date} at {booking_time} has been submitted by {concierge_name}. To Modify Click {modify_url}. Thank you for booking with us. (https://primaapp.com)',
        ...
        'venue_contact_booking_confirmed_hike' => 'PRIMA Booking @ {venue_name} {booking_date_time}, {guest_count} guests, {guest_name}, {guest_phone}. Click {confirmation_url} to confirm.',
        'venue_contact_booking_confirmed_notes_hike' => "PRIMA Booking @ {venue_name} {booking_date_time}, {guest_count} guests, {guest_name}, {guest_phone}. Click {confirmation_url} to confirm.\n\nNotes: {notes}",
        'venue_contact_booking_confirmed_reminder_hike' => "Reminder:\n\nPRIMA Booking @ {venue_name} {booking_date_time}, {guest_count} guests, {guest_name}, {guest_phone}. Click {confirmation_url} to confirm.",
        'venue_contact_booking_confirmed_reminder_notes_hike' => "Reminder:\n\nPRIMA Booking @ {venue_name} {booking_date_time}, {guest_count} guests, {guest_name}, {guest_phone}. Click {confirmation_url} to confirm.\n\nNotes: {notes}",
