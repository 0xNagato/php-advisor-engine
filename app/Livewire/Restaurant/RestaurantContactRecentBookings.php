...
class RestaurantContactRecentBookings extends Component implements HasForms, HasTable
{
    ...
    public function table(Table $table): Table
    {
        $query = Booking::confirmedOrNoShow()
            ...
            ->whereHas('restaurant', function ($query) {
                $query->where('restaurants.id', $this->restaurant);
            });

        $this->name = $query->first()->restaurant->name;
    ...
    {
        return view('livewire.restaurant.bookings');
    }
}
