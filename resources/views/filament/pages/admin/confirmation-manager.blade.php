    ...
    <div x-data="{
        ...
        <div x-ref="tabButtons"
            ...
            <button :id="$id(tabId)" @click="tabButtonClicked($el);" type="button"
                ...
                <span
                    ...
                    <span
                        class="absolute -top-3 -right-5 h-5 w-5 rounded-full bg-indigo-500 text-white flex justify-center items-center items"><span>
                            {{ $modificationRequestsCount }}
                        </span></span>
                    <span class="ml-1.5"> Modification Request </span>
                </span>
            </button>
        ...
        <div class="relative w-full mt-2 content">
            <div :id="$id(tabId + '-content')" x-show="tabContentActive($el)" class="relative">
                <livewire:admin.confirmation-manager-bookings />
            </div>

            <div :id="$id(tabId + '-content')" x-show="tabContentActive($el)" class="relative" x-cloak>
                <livewire:admin.confirmation-manager-modifications />
            </div>
