<x-filament-panels::page>
    ...
    <x-filament::section>
        ...
        <form wire:submit="save" class="flex flex-col gap-3">
            ...
            @if ($payout_type === 'PayPal' || $payout_type === 'Check')
                <x-filament::input.wrapper>
                    <x-filament::input type="text" required wire:model="payout_name"
                        placeholder="{{ $payout_type === 'PayPal' ? 'PayPal Email' : 'Name or Company Name' }}" />
                </x-filament::input.wrapper>
            @elseif($payout_type === 'IBAN')
                <x-filament::input.wrapper>
                    <x-filament::input type="text" required wire:model="payout_name" placeholder="IBAN" />
                </x-filament::input.wrapper>
            @elseif($payout_type === 'Direct Deposit')
                <x-filament::input.wrapper>
                    <x-filament::input type="text" required wire:model="routing_number"
                        placeholder="Routing Number" />
                </x-filament::input.wrapper>
                <x-filament::input.wrapper>
                    <x-filament::input type="text" required wire:model="account_number"
    ...
    <x-filament::section>
        ...
        <form wire:submit="save" class="flex flex-col gap-3">
            ...
            <x-filament::input.wrapper>
                <x-filament::input type="text" wire:model="charity_percentage"
