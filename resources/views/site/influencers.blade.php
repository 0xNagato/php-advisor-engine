...
@section('title', 'Influencers - PRIMA')
...
<div id="panelHeader" class="collapsible">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 border-t border-slate-200 bg-white shadow-sm">
        <div class="flex items-center justify-between mb-4">
            <h3 class="text-xl font-bold">Join PRIMA</h3>
        ...
        <form action="#" method="post" class="space-y-3">
            <div>
                ...
                <input type="text"
                       class="mt-1 w-full rounded-xl border border-slate-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            ...
            <div>
                <label class="block text-sm font-medium text-slate-700">Primary Platform</label>
                <select
                        class="mt-1 w-full rounded-xl border border-slate-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500">
            ...
            <div>
                <label class="block text-sm font-medium text-slate-700">Audience Size</label>
                <input type="text"
                       class="mt-1 w-full rounded-xl border border-slate-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500"
    ...
    <div class="max-w-5xl mx-auto px-4 md:px-6 relative z-10">
        <div class="flex flex-col justify-center items-center text-center wow animate__animated animate__zoomIn">
            <h1 class="text-[34px] md:text-[65px] leading-[1] font-black">Turn <span
                    class="text-indigo-600">Influence</span> Into <span class="text-indigo-600">Revenue</span></h1>
...
<!-- Why Influencers Work With PRIMA BLOCK -->
<section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
    <div class="rounded-2xl bg-gradient-to-r from-indigo-50 to-purple-50 shadow-md p-4 text-center">
        <h2 class="text-4xl font-semibold mt-4 mb-8 wow animate__animated animate__zoomIn">
            <span class="relative text-center z-10">Why
                <span class="relative inline-block">
                    ...
                    <span class="absolute left-0 right-0 -bottom-1 h-4 z-0 pointer-events-none"
        ...
        <div class="grid md:grid-cols-2 gap-4 text-left">
            <div
                    class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInLeft">
                <div class="flex flex-col justify-center h-full">
            ...
            <div
                    class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInRight">
                <div class="flex flex-col justify-center h-full">
                    <span class="flex items-center justify-center rounded-full w-[100px] h-[100px] bg-indigo-600">
        ...
        <div class="grid md:grid-cols-3 gap-4 text-left wow animate__animated animate__zoomIn">
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
                ...
                <div>
                    ...
                    <p class="text-black">Choose any restaurant or group from the PRIMA Marketplace. Get unique tracking links.</p>
                </div>
            </div>
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
                <div class="flex flex-col h-full">
                ...
                <div>
                    ...
                    <p class="text-black">Drop links in bios, Linktree, stories, posts, newsletters, and SMS. Use VIP links for 1:1 shares.</p>
                </div>
            </div>
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
                <div class="flex flex-col h-full">
        ...
        <div class="grid md:grid-cols-3 gap-4 text-left wow animate__animated animate__zoomIn">
            ...
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
                ...
                <p class="text-black">
                    ...
                    <a href="https://www.storyclash.com/blog/en/influencer-marketing-roi/" target="_blank"
                       class="text-indigo-600 underline text-xs">[Storyclash, 2024]</a>
                </p>
            </div>
            ...
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
                ...
                <p class="text-black">
                    ...
                    <a href="https://investors.sproutsocial.com/news/news-details/2024/New-Research-Reveals-Influencers-Significantly-Drive-Purchasing-Decisions/default.aspx"
                       target="_blank" class="text-indigo-600 underline text-xs">[Sprout Social, 2024]</a>
                </p>
            </div>
            ...
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
                ...
                <p class="text-black">
                    ...
                    <a href="https://www.emarketer.com/chart/269287/us-social-commerce-sales-will-surpass-100-billion-2026-billions-us-social-commerce-sales-change-of-total-retail-ecommerce-sales-2022-2028"
                       target="_blank" class="text-indigo-600 underline text-xs">[eMarketer, 2024]</a>
                </p>
            </div>
            ...
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
                ...
                <p class="text-black">
                    ...
                    <a href="https://www.businessinsider.com/influencers-social-other-affiliate-marketers-drove-us-cyber-monday-revenue-2024-12"
                       target="_blank" class="text-indigo-600 underline text-xs">[Business Insider, 2024]</a>
                </p>
            </div>
            ...
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
                ...
                <p class="text-black">
                    ...
                    <a href="https://influencers.club/blog/state-of-the-link-in-bio-market/" target="_blank"
                       class="text-indigo-600 underline text-xs">[Influencers Club, 2024]</a>
                </p>
            </div>
            ...
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
                ...
                <p class="text-black">
                    ...
                    <a href="https://www.theverge.com/news/667588/threads-multiple-profile-link-sharing-update" target="_blank"
                       class="text-indigo-600 underline text-xs">[The Verge, 2025]</a>
                </p>
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-4 text-left">
            <div class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInLeft">
                ...
                <div>
                    ...
                    <p class="text-black">Track clicks, bookings, and covers without spreadsheets.</p>
                </div>
            </div>
            <div class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInRight">
                ...
                <div>
                    ...
                    <p class="text-black">Predictable payouts for all seated diners in the pay period.</p>
                </div>
            </div>
            <div class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInLeft">
                <div class="flex flex-col justify-center h-full">
