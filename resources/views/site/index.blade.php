    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-[3fr_2fr] gap-2 items-center h-full">
            ...
            <div class="flex flex-col justify-right justify-end wow animate__animated animate__fadeInLeft">
                <h1 class="text-[34px] md:text-[65px] leading-[1] font-black">The <span
                        class="text-indigo-600">Platform</span> That <span class="text-indigo-600">Connects</span> Hospitality
                </h1>
                <div
                        class="max-w-3xl mx-auto rounded-2xl items-start bg-gradient-to-r from-indigo-50 to-purple-50 shadow-md p-4 mt-8 text-[18px] md:text-[20px] space-y-1 text-left">
                    ...
                    <div><label class="inline-flex items-start space-x-3 text-xl"><span
                                class="flex items-center justify-center p-1 rounded-full border-2 border-indigo-600"><i
                                    data-lucide="check" class="w-4 h-4 text-indigo-600"></i></span><span><strong>Restaurants</strong>
                                fill seats with
                                high-intent diners.</span></label></div>
                    <div><label class="inline-flex items-start space-x-3 text-xl"><span
                                class="flex items-center justify-center p-1 rounded-full border-2 border-indigo-600"><i
                                    data-lucide="check" class="w-4 h-4 text-indigo-600"></i></span><span><strong>Concierges</strong> get
                                credit for every
                                booking.</span></label></div>
                    <div><label class="inline-flex items-start space-x-3 text-xl"><span
                                class="flex items-center justify-center p-1 rounded-full border-2 border-indigo-600"><i
                                    data-lucide="check" class="w-4 h-4 text-indigo-600"></i></span><span><strong>Influencers</strong>
                                prove impact through
                                measurable bookings.</span></label>
                    </div>
                    <div><label class="inline-flex items-start space-x-3 text-xl"><span
                                class="flex items-center justify-center p-1 rounded-full border-2 border-indigo-600"><i
                                    data-lucide="check" class="w-4 h-4 text-indigo-600"></i></span><span><strong>Hotels</strong>
                                generate ancillary revenue while improving service levels.</span></label></div>
                    <div><label class="inline-flex items-start space-x-3 text-xl"><span
                                class="flex items-center justify-center p-1 rounded-full border-2 border-indigo-600"><i
                                    data-lucide="check" class="w-4 h-4 text-indigo-600"></i></span><span><strong>Everybody</strong>
                                Wins<span style="position:relative;display:inline-block;"> <sup
                                        style="font-size:0.5em;position:absolute;top: 0.8em;right:-0.8em;">TM</sup>.</span></span></label>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-center md:justify-left mt-6 md:mt-0 wow animate__animated animate__fadeInRight">
                <img src="{{ asset('images/site/hero-placeholder.png') }}" alt="PRIMA platform preview"
                     class="w-auto h-[700px] [transform:rotateY(20deg)_rotateX(-20deg)]" />
            </div>
        </div>
        <div
                class="absolute w-[130px] md:w-[170px] z-[999999] bottom-[-90px] md:bottom-[-110px] right-[-5px] md:right-[10px] lg:right-[-60px] wow animate__animated animate__fadeInRight">
            <div>
    ...
    <div class="rounded-2xl overflow-hidden shadow-md border border-slate-300">
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-[1px]">
            <a href="https://book.primaapp.com/miami" target="_blank"
               ...
               style="background-image: url('{{ asset('images/site/miami.jpg') }}'); background-size: cover; background-position: center center;">
                <div
                        class="absolute inset-0 bg-black opacity-30 group-hover:opacity-50 pointer-events-none transition-opacity duration-300">
                </div>
            ...
            <a href="https://book.primaapp.com/los-angeles" target="_blank"
               ...
               style="background-image: url('{{ asset('images/site/los-angeles.jpg') }}'); background-size: cover; background-position: center center;">
                <div
                        class="absolute inset-0 bg-black opacity-30 group-hover:opacity-50 pointer-events-none transition-opacity duration-300">
                </div>
                <div class="relative z-10 flex items-start justify-between">
            ...
            <a href="https://book.primaapp.com/ibiza" target="_blank"
               ...
               style="background-image: url('{{ asset('images/site/Ibiza.webp') }}'); background-size: cover; background-position:center 185px;">
                <div
                        class="absolute inset-0 bg-black opacity-30 group-hover:opacity-50 pointer-events-none transition-opacity duration-300">
                </div>
                <div class="relative z-10 flex items-start justify-between">
...
<section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
    <div class="rounded-2xl bg-gradient-to-r from-indigo-50 to-purple-50 shadow-md p-4 text-center">
        ...
        <div class="grid md:grid-cols-2 gap-6 text-left wow animate__animated animate__zoomIn">
            <div
                    class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
    ...
    <div class="rounded-2xl bg-gradient-to-r from-indigo-50 to-purple-50 shadow-md p-4 md:p-8">
        ...
        <div class="grid md:grid-cols-12 gap-10 items-center justify-center">
            <div class="md:col-span-7 wow animate__animated animate__fadeInLeft">
                ...
                <a href="{{ route('site.hotels') }}"
                   class="inline-block mt-4 mr-2 px-6 py-3 rounded-full bg-gradient-to-r from-emerald-500 to-green-600 text-white text-lg font-semibold shadow-[3px_3px_0_#047857] hover:opacity-90 active:translate-x-[3px] active:translate-y-[3px] active:shadow-none transition-all duration-150">Learn
                    More</a>
                <a type="button" data-target="panelHeader"
                   class="inline-block mt-4 cursor-pointer px-6 py-3 rounded-full bg-gradient-to-r from-emerald-500 to-green-600 text-white text-lg font-semibold shadow-[3px_3px_0_#047857] hover:opacity-90 active:translate-x-[3px] active:translate-y-[3px] active:shadow-none transition-all duration-150">Join
                    PRIMA</a>

            </div>
            <div class="flex justify-center md:justify-center md:col-span-5 wow animate__animated animate__fadeInRight">
                <img src="{{ asset('images/site/hotels.jpg') }}" alt="Resort hotel pool at sunset"
                     class="w-full md:max-w-xl rounded-2xl shadow-2xl ring-1 md:-mb-0 mb-[-175px] border-2 border-white ring-white/20 object-cover aspect-[4/3]" />
            </div>
        </div>
    </div>
</section>
...
<section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 md:mt-8 mt-[200px]">
    <div class="rounded-2xl overflow-hidden stripe-gradient-bg shadow-md p-4">
        <div class="grid lg:grid-cols-3 gap-2 md:gap-[1px] wow animate__animated animate__zoomIn">
            ...
            <!-- First Item -->
            <div
                    class="flex h-full w-full flex-row items-center justify-start md:justify-center text-left pb-2 md:pb-0 border-b-2 md:border-b-0 md:border-r-2 border-slate-400 gap-4">
                <span
                        class="flex items-center justify-center text-center rounded-full w-[70px] h-[70px] bg-indigo-600 text-white text-[20px] font-extrabold">
            ...
            <!-- Second Item -->
            <div
                    class="flex h-full w-full flex-row items-center justify-start md:justify-center text-left pl-0 md:pl-6 pb-2 md:pb-0 border-b-2 md:border-b-0 md:border-r-2 border-slate-400 gap-4">
                <span
                        class="flex items-center justify-center text-center rounded-full w-[70px] h-[70px] bg-emerald-600 text-white text-[20px] font-extrabold">
            ...
            <!-- Third Item -->
            <div
                    class="flex h-full w-full flex-row items-center justify-left pl-0 md:pl-6 md:justify-center text-left gap-4">
                <span
                        class="flex items-center justify-center text-center rounded-full w-[70px] h-[70px] bg-pink-600 text-white text-[20px] font-extrabold">
    ...
    <div class="rounded-2xl bg-gradient-to-r from-indigo-50 to-purple-50 shadow-md p-4 md:p-8">
        <div class="grid md:grid-cols-12 gap-10 items-center justify-center">
            ...
            <div class="flex justify-center md:justify-start md:col-span-5 wow animate__animated animate__fadeInRight">
                <img src="{{ asset('images/site/restaurants.webp') }}" alt="Elegant restaurant interior"
                     class="w-full md:max-w-xl rounded-2xl shadow-2xl ring-1 md:-mb-0 mb-[-175px] border-2 border-white ring-white/20 object-cover aspect-[4/3]" />
            </div>
        </div>
    </div>
    ...
    <div class="rounded-2xl bg-gradient-to-r from-indigo-50 to-purple-50 shadow-md p-4 md:p-8">
        <div class="grid md:grid-cols-12 gap-10 items-center justify-center">
            <div class="md:col-span-7 wow animate__animated animate__fadeInLeft">
                ...
                <a href="{{ route('site.concierges') }}"
                   class="inline-block mt-4 mr-2 px-6 py-3 rounded-full bg-gradient-to-r from-emerald-500 to-green-600 text-white text-lg font-semibold shadow-[3px_3px_0_#047857] hover:opacity-90 active:translate-x-[3px] active:translate-y-[3px] active:shadow-none transition-all duration-150">Learn
                    More</a>
                <a type="button" data-target="panelHeader"
                   class="inline-block mt-4 px-5 cursor-pointer px-6 py-3 rounded-full bg-gradient-to-r from-emerald-500 to-green-600 text-white text-lg font-semibold shadow-[3px_3px_0_#047857] hover:opacity-90 active:translate-x-[3px] active:translate-y-[3px] active:shadow-none transition-all duration-150">Join
                    PRIMA</a>
            </div>
            <div class="flex justify-center md:justify-end md:col-span-5 wow animate__animated animate__fadeInRight">
                <img src="{{ asset('images/site/concierge.jpg') }}" alt="Concierge assisting guest at a hotel desk"
                     class="w-full md:max-w-xl rounded-2xl shadow-2xl ring-1 md:-mb-0 mb-[-175px] border-2 border-white ring-white/20 object-cover aspect-[4/3]" />
            </div>
        </div>
    </div>
...
<!-- INFLUENCERS SECTION -->
<section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 mb-16 md:mt-8 mt-[175px]">
    <div class="rounded-2xl bg-gradient-to-r from-indigo-50 to-purple-50 shadow-md p-4 md:p-8">
        <div class="grid md:grid-cols-12 gap-10 items-center justify-center">
            <div class="md:col-span-7 wow animate__animated animate__fadeInLeft">
            ...
            <div class="flex justify-center md:justify-start md:col-span-5 wow animate__animated animate__fadeInRight">
                <img src="{{ asset('images/site/influencers.webp') }}" alt="Food influencer capturing a restaurant dish"
                     class="w-full md:max-w-xl rounded-2xl shadow-2xl ring-1 md:-mb-0 mb-[-175px] ring-white/20 object-cover border-2 border-white aspect-[4/3]" />
            </div>
        </div>
    </div>
</section>
