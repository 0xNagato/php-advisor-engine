...
<section id="hero" class="relative py-10">
    ...
    <div class="max-w-5xl mx-auto px-4 md:px-6 relative z-10">
      <div class="flex flex-col text-center wow animate__animated animate__zoomIn">
        <h1 class="text-[34px] md:text-[65px] leading-[1] font-black">Turn <span class="text-indigo-600">High‑Intent</span> Guests Into Predictable <span class="text-indigo-600">Revenue</span>
        </h1>
        ...
        <div class="max-w-4xl mx-auto rounded-2xl items-start bg-gradient-to-r from-indigo-50 to-purple-50 shadow-md p-4 mt-7 text-[18px] md:text-[20px] space-y-1 text-left">
          <div>
            <label class="inline-flex justify-start items-start text-left space-x-3 text-xl">
              <span class="flex justify-center p-1 rounded-full border-2 border-indigo-600">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-lucide="check" class="lucide lucide-check w-4 h-4 text-indigo-600">
          ...
          <div><label class="inline-flex items-start space-x-3 text-xl"><span class="flex justify-center p-1 rounded-full border-2 border-indigo-600"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-lucide="check" class="lucide lucide-check w-4 h-4 text-indigo-600">
                  <path d="M20 6 9 17l-5-5"></path>
      ...
      <div class="grid md:grid-cols-2 gap-6 text-left wow animate__animated animate__zoomIn">
        <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInLeft">
          ...
          <div>
            ...
            <p class="text-black">Reach travelers and locals already in the city and actively looking to book a
              memorable experience tonight or this week.</p>
          </div>
        </div>
        <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInRight">
          ...
          <div>
            ...
            <p class="text-black">Offer premium access for peak tables. PRIMA shares 60% of the access fee with your
              restaurant.</p>
          </div>
        </div>
        <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInLeft">
          ...
          <div>
            ...
            <p class="text-black">See performance by hotel, concierge, influencer, or promo. Compare covers,
              revenue, and net margin.</p>
          </div>
        </div>
        <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInRight">
          <div class="flex flex-col justify-center h-full">
          ...
          <div>
            ...
            <p class="text-black">Manage internal hosts, external promoters, and influencers with unified tracking
              and payouts.</p>
          </div>
        </div>
      </div>
      ...
      <div class="grid md:grid-cols-3 gap-4 text-left wow animate__animated animate__zoomIn">
        <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
          ...
          <div>
            ...
            <p class="text-black">Connect your reservation system or choose messaging fulfillment. Set table rules
              and
              pricing for premium access.</p>
          </div>
        </div>
        <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
          <div class="flex flex-col h-full">
          ...
          <div>
            ...
            <p class="text-black">Publish inventory to hotels, concierges, influencers, and your own channels via
              the PRIMA interface.</p>
          </div>
        </div>
        <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
          <div class="flex flex-col h-full">
          ...
          <div>
            ...
            <p class="text-black">PRIMA attributes each seated cover and deposits payouts twice monthly with full
              reporting.</p>
          </div>
        </div>
      </div>
    ...
    <div class="rounded-2xl stripe-gradient-bg shadow-md p-4 text-center">
      ...
      <div class="grid md:grid-cols-3 gap-4 text-left wow animate__animated animate__zoomIn">
        ...
        <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
          ...
          <p class="text-black">
            Fine dining sales from travelers and visitors in typical pre-COVID years, showing out-of-town guests are a
            major revenue.
            <a class="text-indigo-600 underline text-xs" target="_blank" href="https://restaurant.org/education-and-resources/resource-library/tourism-related-spending-in-restaurants-fell-sharply-in-recent-months/">National
              Restaurant Association</a>
          </p>
        </div>
        ...
        <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
          ...
          <p class="text-black">
            ...
            <a class="text-indigo-600 underline text-xs" target="_blank" href="https://www.costar.com/article/1787677919/majority-of-hotel-guest-spending-comes-outside-of-room-rate">CoStar,
              2023</a>
          </p>
        </div>
        ...
        <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
          ...
          <p class="text-black">
            ...
            <a class="text-indigo-600 underline text-xs" target="_blank" href="https://cgastrategy.com/go-technology-hotels-and-consumers/">CGA
              Strategy, 2025</a>
          </p>
        </div>
        ...
        <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
          ...
          <p class="text-black">
            ...
            <a class="text-indigo-600 underline text-xs" target="_blank" href="https://pos.toasttab.com/blog/on-the-line/restaurant-reservations-and-wait-times-data">Toast Data
              Study</a>
          </p>
        </div>
        ...
        <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
          ...
          <p class="text-black">
            Diners who go directly to the restaurant website to book, reinforcing the value of a clean, direct PRIMA
            interface.
            <a class="text-indigo-600 underline text-xs" target="_blank" href="https://pos.toasttab.com/blog/on-the-line/restaurant-reservations-and-wait-times-data">Toast Data
              Study</a>
          </p>
        ...
        <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
          ...
          <p class="text-black">
            Food tourists spend about a quarter of their travel budget on food and beverages, signaling higher spend
            potential.
            <a class="text-indigo-600 underline text-xs" target="_blank" href="https://www.ucf.edu/online/hospitality/news/food-tourism/">UCF citing
              WFTA</a>
          </p>
        </div>
      ...
      <div class="grid md:grid-cols-2 gap-4 text-left">
        <div class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInLeft">
          ...
          <div>
            ...
            <p class="text-black">PRIMA integrates with leading reservation and table‑management systems. Inventory
              and covers post to your backend automatically.</p>
          </div>
        </div>
        <div class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInRight">
          ...
          <div>
            ...
            <p class="text-black">Operate via SMS or WhatsApp with management confirmations, secure links, and full
              audit trail.</p>
          </div>
        </div>
        <div class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInLeft">
          ...
          <div>
            ...
            <p class="text-black">Attribute every cover to the source. Compare hotels, concierges, influencers, and
              local marketing in one dashboard.</p>
          </div>
        </div>
        <div class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInRight">
          <div class="flex flex-col justify-center h-full">
          ...
          <div>
            ...
            <p class="text-black">Set spend floors, party sizes, release windows, and blackout dates to protect your
              average check and guest mix.</p>
          </div>
        </div>
      </div>
      <div class="text-center mt-6 mb-3 wow animate__animated animate__fadeInUp">
    ...
    <div class="rounded-2xl bg-gradient-to-r from-indigo-50 to-purple-50 shadow-md p-4">
      ...
      <div class="faq-list flex flex-col gap-4">
        <div class="faq-item border rounded-xl overflow-hidden wow animate__animated animate__fadeInUp">
          <button class="w-full text-left px-6 py-4 bg-white font-semibold text-lg flex justify-between items-center faq-toggle" aria-expanded="true">
          ...
          <div class="faq-answer px-6 pb-4 bg-white text-slate-700 block">
            You set rules on party size, spend floors, and release timing. PRIMA routes high‑intent demand to tables
            that
            fit your goals and measures realized check size.
          </div>
        </div>
        <div class="faq-item border rounded-xl overflow-hidden wow animate__animated animate__fadeInUp">
          <button class="w-full text-left px-6 py-4 bg-white font-semibold text-lg flex justify-between items-center faq-toggle" aria-expanded="false">
        ...
        <div class="faq-item border rounded-xl overflow-hidden wow animate__animated animate__fadeInUp">
          ...
          <div class="faq-answer bg-white px-6 pb-4 text-slate-700 hidden">
            PRIMA charges an access fee for premium tables. 60% of that fee is paid to your restaurant in addition to
            the
            guest check.
          </div>
        </div>
        <div class="faq-item border rounded-xl overflow-hidden wow animate__animated animate__fadeInUp">
          ...
          <div class="faq-answer bg-white px-6 pb-4 text-slate-700 hidden">
            Yes. Track internal hosts and external promoters from one dashboard with unified links, attribution, and
            payouts.
          </div>
        </div>
      </div>
