...
@section('title', 'Concierges - PRIMA')
...
<section id="hero" class="relative py-10">
    ...
    <div class="max-w-5xl mx-auto px-4 md:px-6 relative z-10">
        <div class="flex flex-col text-center wow animate__animated animate__zoomIn">
            <h1 class="text-[34px] md:text-[65px] leading-[1] font-black">Unlock <span
                    class="text-indigo-600">Sold-Out</span> Tables
            </h1>
...
<section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
    ...
    <div class="text-center mt-6 wow animate__animated animate__fadeInUp">
        <button type="button" data-target="panelHeader"
                class="cta-btn cursor-pointer px-6 py-3 rounded-full bg-gradient-to-r from-emerald-500 to-green-600 text-white text-lg font-semibold shadow-[3px_3px_0_#047857] hover:opacity-90 active:translate-x-[3px] active:translate-y-[3px] active:shadow-none transition-all duration-150">Book
            With PRIMA</button>
    </div>
</section>
        ...
        <div class="grid md:grid-cols-2 gap-6 text-left wow animate__animated animate__zoomIn">
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInLeft">
                ...
                <div>
                    ...
                    <p class="text-black">Unlock impossible-to-get reservations at the world's most in-demand restaurants, ensuring your guests always receive VIP treatment.</p>
                </div>
            </div>
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInRight">
                ...
                <div>
                    ...
                    <p class="text-black">PRIMA generates revenue from every booking and shares that revenue directly with concierges, creating new income streams for your role.</p>
                </div>
            </div>
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInLeft">
                <div class="flex flex-col justify-center h-full">
                ...
                <div>
                    ...
                    <p class="text-black">Every booking you make is tracked in real time, so you are recognized and rewarded for the value you bring to your property and partners.</p>
                </div>
            </div>
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInRight">
                <div class="flex flex-col justify-center h-full">
                ...
                <div>
                    ...
                    <p class="text-black">Enhance your guests' stay with unforgettable dining experiences that elevate satisfaction and loyalty.</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-4 text-left">
            <div class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInLeft">
                ...
                <div>
                    ...
                    <p class="text-black">See every booking, status change, seated count, and commission in one place with real-time sync.</p>
                </div>
            </div>
            <div class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInRight">
                ...
                <div>
                    ...
                    <p class="text-black">Payouts land on a predictable schedule for all diners seated within the pay period, with clear accruals.</p>
                </div>
            </div>
            <div class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInLeft">
                <div class="flex flex-col justify-center h-full">
                ...
                <div>
                    ...
                    <p class="text-black">Modify, cancel, or adjust reservations in a few clicks. Changes propagate to partners and guest notifications automatically.</p>
                </div>
            </div>
            <div class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInRight">
                <div class="flex flex-col justify-center h-full">
                ...
                <div>
                    ...
                    <p class="text-black">Every reservation and payout is logged with precision, ensuring your trust in PRIMA's transparent processes.</p>
                </div>
            </div>
        </div>
    </div>
