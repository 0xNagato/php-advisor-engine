...
<section id="hero" class="relative py-10">
    ...
    <div class="max-w-5xl mx-auto px-4 md:px-6 relative z-10">
        <div class="flex flex-col justify-center items-center text-center wow animate__animated animate__zoomIn">
            <h1 class="text-[34px] md:text-[65px] leading-[1] font-black">Give Your <span
                    class="text-indigo-600">Guests</span> The <span class="text-indigo-600">Amenity</span> They Truly Want
            </h1>
...
<section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-[1px]">
            <a href="https://book.primaapp.com/miami" target="_blank"
               ...
               style="background-image: url('{{ asset('images/site/miami.jpg') }}'); background-size: cover; background-position: center center;">
                <div class="absolute inset-0 bg-black opacity-30 group-hover:opacity-50 pointer-events-none transition-opacity duration-300"></div>
            ...
            <a href="https://book.primaapp.com/ibiza" target="_blank"
               ...
               style="background-image: url('{{ asset('images/site/Ibiza.webp') }}'); background-size: cover; background-position: center bottom;">
                <div class="absolute inset-0 bg-black opacity-30 group-hover:opacity-50 pointer-events-none transition-opacity duration-300"></div>
                <div class="relative z-10 flex items-start justify-between">
                    <span class="text-xs font-semibold tracking-widest text-white uppercase">Market</span>
                    <button class="px-3 py-1 rounded-lg bg-indigo-600 text-white text-sm hover:bg-indigo-700">Book Now</button>
    ...
    <div class="text-center mt-6 mb-4 wow animate__animated animate__fadeInUp">
        <button type="button" data-target="panelHeader"
                class="px-6 py-3 rounded-full bg-gradient-to-r from-emerald-500 to-green-600 text-white text-lg font-semibold shadow-[3px_3px_0_#047857] hover:opacity-90 active:translate-x-[3px] active:translate-y-[3px] active:shadow-none transition-all duration-150">Partner
            With
            PRIMA</button>
    </div>
</section>

<!-- Why Hotels and AirBNB BLOCK -->
        ...
        <div class="grid md:grid-cols-2 gap-4 text-left">
            <div class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInLeft">
                ...
                <div>
                    ...
                    <p class="text-black">Unlock tough reservations at in‑demand restaurants so your guests always have great options.</p>
                </div>
            </div>
            <div class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInRight">
                ...
                <div>
                    ...
                    <p class="text-black">Earn a share of booking revenue. Whether guests dine on property or off property, your property still earns.</p>
                </div>
            </div>
            <div class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInLeft">
                <div class="flex flex-col justify-center h-full">
                ...
                <div>
                    ...
                    <p class="text-black">Track every booking and seated cover in real time. See guest benefits and commission status clearly.</p>
                </div>
            </div>
            <div class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInRight">
                <div class="flex flex-col justify-center h-full">
                ...
                <div>
                    ...
                    <p class="text-black">Deliver memorable dining experiences that lift satisfaction, reviews, and repeat bookings.</p>
                </div>
            </div>
        </div>
        <div class="text-center mt-6 mb-4 wow animate__animated animate__fadeInUp">
        ...
        <div class="grid md:grid-cols-3 gap-4 text-left wow animate__animated animate__zoomIn">
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
                ...
                <div>
                    ...
                    <p class="text-black">Place branded QR stands or tent cards in rooms, suites, and common areas. Guests scan and book in seconds.</p>
                </div>
            </div>
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
                <div class="flex flex-col h-full">
                ...
                <div>
                    ...
                    <p class="text-black">Send pre‑arrival emails, plus texts or emails after check‑in, with a direct link to your PRIMA hub.</p>
                </div>
            </div>
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
                <div class="flex flex-col h-full">
                ...
                <div>
                    ...
                    <p class="text-black">Concierge teams can book on behalf of guests with full crediting and visibility across departments.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="rounded-2xl stripe-gradient-bg shadow-md p-4 text-center">
        ...
        <div class="grid md:grid-cols-3 gap-4 text-left wow animate__animated animate__zoomIn">
            ...
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
                ...
                <p class="text-black">
                    Travelers report dining out for most meals while on the road. Your guests want easy access to great restaurants.
                    <a href="https://press.opentable.com/news-releases/news-release-details/opentable-reveals-travel-dining-trends"
                       target="_blank" class="text-indigo-600 underline text-xs">[OpenTable, 2023]</a>
                </p>
            </div>
            ...
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
                ...
                <p class="text-black">
                    ...
                    <a href="https://www.ahla.com/sites/default/files/2022-08/AHLA-Oxford-Economics-Hotel-Industry-Impact-Study.pdf"
                       target="_blank" class="text-indigo-600 underline text-xs">[AHLA/Oxford Economics, 2022]</a>
                </p>
            </div>
            ...
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100">
                ...
                <p class="text-black">
                    ...
                    <a href="https://pos.toasttab.com/blog/on-the-line/restaurant-diner-survey" target="_blank"
                       class="text-indigo-600 underline text-xs">[Toast Diner Survey, 2023]</a>
                </p>
            </div>
        </div>
    </div>
...
<!-- Transparent Reporting and Payments BLOCK -->
<section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
    <div class="rounded-2xl bg-gradient-to-r from-indigo-50 to-purple-50 shadow-md p-4 text-center">
        <h2 class="text-4xl font-semibold mt-4 mb-8 wow animate__animated animate__zoomIn">
            <span class="relative text-center z-10">
        ...
        <div class="grid md:grid-cols-2 gap-4 text-left">
            <div class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInLeft">
                ...
                <div>
                    ...
                    <p class="text-black">View bookings, status changes, seated covers, and commissions in one dashboard.</p>
                </div>
            </div>
            <div class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInRight">
                <div class="flex flex-col justify-center h-full">
                ...
                <div>
                    ...
                    <p class="text-black">Predictable payouts for all seated diners in the pay period with clear accruals.</p>
                </div>
            </div>
            <div class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInLeft">
                <div class="flex flex-col justify-center h-full">
                ...
                <div>
                    ...
                    <p class="text-black">Modify or cancel reservations in a few clicks. Updates propagate to partners and guest notifications.</p>
                </div>
            </div>
            <div class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition hover:bg-violet-100 wow animate__animated animate__fadeInRight">
                <div class="flex flex-col justify-center h-full">
                ...
                <div>
                    ...
                    <p class="text-black">Every reservation and payout is logged with precision for audit‑ready transparency.</p>
                </div>
            </div>
        </div>
        <div class="text-center mt-6 mb-4 wow animate__animated animate__fadeInUp">
            <button type="button" data-target="panelHeader"
                    class="px-6 py-3 rounded-full bg-gradient-to-r from-emerald-500 to-green-600 text-white text-lg font-semibold shadow-[3px_3px_0_#047857] hover:opacity-90 active:translate-x-[3px] active:translate-y-[3px] active:shadow-none transition-all duration-150">
                Partner With PRIMA
            </button>
        </div>
    </div>
...
<section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
    <div class="rounded-2xl bg-gradient-to-r from-indigo-50 to-purple-50 shadow-md p-8 text-center wow animate__animated animate__fadeInUp">
        <div class="flex flex-col items-center justify-center gap-4">
            ...
            <a href="#"
               class="inline-block px-6 py-3 rounded-full bg-gradient-to-r from-emerald-500 to-green-600 text-white text-lg font-semibold shadow-[3px_3px_0_#047857] hover:opacity-90 active:translate-x-[3px] active:translate-y-[3px] active:shadow-none transition-all duration-150">Schedule
                A Call</a>
        </div>
    </div>
</section>
