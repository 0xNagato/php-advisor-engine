                ...
                <div class="p-6 md:p-8 text-gray-900">
                    ...
                    <div class="space-y-6 text-base">
                        ...
                        @if(isset($showPlatformLink) && $showPlatformLink)
                            <div class="mt-8 border-t pt-6">
                                <p class="mb-4 text-sm">View this announcement in the platform for full features.</p>
                                <a href="{{ $platformUrl }}" class="inline-flex items-center justify-center w-full md:w-auto px-6 py-3 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150 no-underline hover:no-underline !decoration-transparent" style="text-decoration: none !important;">
                                    <span class="text-white">View in Platform</span>
                                </a>
                            </div>
                        @endif
                    </div>
