    ...
    <div class="container">
        <div class="flex flex-col gap-4 md:text-center items-start md:items-center">
            ...
            <h2 class="text-dark m-auto">
                Effortless Reservation Management with PRIMA
            </h2>
            ...
            <div class="box_grid">
                <div class="box_grid-item">
                    ...
                    <div class="flex flex-col items-center relative overflow-hidden max-h-[300px] px-5">
                        ...
                        <img src="{{ asset('images/marketing/reservation-1.png') }}" alt="reservation-picture" class="relative z-[1] max-h-[100%] h-[auto]">
                    </div>
                    <!-- nav -->
                ...
                <div class="box_grid-item">
                    ...
                    <div class="flex flex-col items-center relative overflow-hidden max-h-[300px] px-5">
                        <img src="{{ asset('images/marketing/dots_bg.png') }}" alt="dots" class="absolute top-0 left-0 right-0 m-auto max-w-[400px] w-full">
                        <img src="{{ asset('images/marketing/reservation-2.png') }}" alt="reservation-picture" class="relative z-[1] max-h-[100%] h-[auto]">">
                    </div>
                    <!-- nav -->
                    <div class="box_grid-numering">
                        <img src="{{ asset('images/marketing/line-left.svg') }}" alt="line-left" class="w-auto">
                ...
                <div class="box_grid-item">
                    ...
                    <div class="flex flex-col items-center relative overflow-hidden max-h-[300px] px-5">
                        <img src="{{ asset('images/marketing/dots_bg.png') }}" alt="dots" class="absolute top-0 left-0 right-0 m-auto max-w-[400px] w-full">
                        <img src="{{ asset('images/marketing/analytics-2.png') }}" alt="reservation-picture" class="relative z-[1] max-h-[100%] h-[auto]">">
                    </div>
                    <!-- nav -->
                    <div class="box_grid-numering">
                        <img src="{{ asset('images/marketing/line-left.svg') }}" alt="line-left" class="w-auto">
                    ...
                    <div class="box_grid-info">
                        ...
                        <p class="box_grid-description">
                            Track real-time reservations, earnings, and performance through the PRIMA platform, giving you full transparency and control over your bookings.
                        </p>
                    </div>
                </div>
            </div>
