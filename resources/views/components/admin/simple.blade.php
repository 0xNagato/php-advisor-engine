...
<div class="pb-4">
    ...
    <div class="p-2 mb-1 text-2xl font-bold tracking-tight text-center dm-serif text-gray-950">
        Everybody Wins<span class="font-sans font-normal">™</span>
    </div>

    @if ($showWrapper)
        <div
            class="bg-white px-6 pt-4 pb-8 shadow-sm ring-1 ring-gray-950/5 rounded-lg mx-4 {{ $containerSize }} sm:mx-auto">
    @endif
