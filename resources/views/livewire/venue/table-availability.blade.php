                    ...
                    <table class="w-full text-xs table-fixed">
                        ...
                        <tbody>
                            @foreach ($times as $time => $partySizes)
                                <tr
                                    class="{{ $loop->iteration % 2 === 0 ? 'bg-gray-50' : 'bg-white' }} border-t border-gray-200">
                                    <td class="font-semibold pl-4">
                                        {{ Carbon::createFromFormat('H:i:s', $time)->format('g:ia') }}</td>
                                        ...
                                        <td class="border-gray-200 py-2 text-center">
                                            <input type="number"
                                                ...
                                                min="0" max="30" @class([
                                                    ...
                                                    'border-red-500 bg-red-100' => $errors->has(
                                                        'schedules.' . $date . '.' . $time . '.' . $partySize),
                                                ])>
                                        </td>
                                    @endforeach
                                </tr>
