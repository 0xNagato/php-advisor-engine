<div class="m-10 bg-white rounded-xl shadow max-w-3xl mx-auto">
    <div class="relative overflow-hidden min-h-32 bg-indigo-800 text-center rounded-t-xl">
    ...
    <div class="p-4 sm:p-7 overflow-y-auto">
        ...
        <div class="mt-5 flex justify-end gap-x-2">
            ...
            <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-indigo-600 text-white hover:bg-indigo-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
               href="#">
                <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                     viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                     stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="mt-5 sm:mt-10">
            <p class="text-sm text-gray-500">If you have any questions, please contact us at <a
                    class="inline-flex items-center gap-x-1.5 text-indigo-600 decoration-2 hover:underline font-medium"
