...
const handleSubmit = async (event: Event) => {
    ...
    if (!phone.value || !phone.value.startsWith("+")) {
        try {
            isLoading.value = true;
            const result = await wire.formatPhoneNumber(
    ...
    try {
        ...
        if (bookingCheck?.error === "multiple_booking") {
            ...
            errorMessage.value =
                bookingCheck.message ?? "Multiple booking detected";
            isLoading.value = false;
            return;
        }
    ...
    <div class="w-full">
        <template v-if="hasExpired">
            ...
            <p class="my-4 text-center">
                ...
                <template v-else>
                    Please consult with your PRIMA Concierge to request a new
                    payment link.
                </template>
            </p>
        ...
        <template v-else-if="isBookingSuccessful">
            ...
            <p class="mb-4 text-center">
                ...
                phone for a text confirmation. We are notifying the venue now.
            </p>
            <p class="mb-4 text-center font-semibold">
                Thank you for using PRIMA!
            </p>
        ...
        <template v-else>
            ...
            <p class="mb-1 text-center font-semibold">
                {{
            ...
            >
                Enter payment details below so that PRIMA may secure your table
                request. 60% of the fee paid is paid to
                {{ mingleData.venueName }} management for opening a previously
                sold-out table.
            </p>
            ...
            <div
                v-if="mingleData.minimumSpendPerGuest"
            ...
            >
                ...
                >
                    ...
                    per diner minimum spend. Booking fees do not apply toward
                    minimum spend or restaurant bill.
                </p>
            </div>
            <div
                v-if="
                    mingleData.venueRegion === 'ibiza' &&
                    mingleData.guestCount >= 8
                "
                class="mb-4 text-justify"
            >
                <p>
                    Note: Parties of 8 or more require additional approval by
                    {{ mingleData.venueName }}. Please submit the reservation
                    request below. Approvals typically take 15-30 minutes
                    (during operating hours). We will notify you as soon as the
                    booking has been approved. Thank you!
                </p>
            </div>
            <form class="w-full" @submit.prevent="handleSubmit">
                ...
                <div class="mb-2">
                    <label for="special-notes" class="sr-only"
                        >Special Notes</label
                    >
                    <textarea
                        id="special-notes"
                ...
                <div class="mx-2 mt-4">
                    <label class="flex items-center">
                        ...
                        <span class="ml-2 text-sm text-gray-700">
                            I agree to receive my reservation confirmation via
                            text message.
                        </span>
                    </label>
                </div>
                <div v-if="mingleData.minimumSpendPerGuest" class="mx-2 mt-2">
                    <label class="flex items-center">
                        ...
                        <span class="ml-2 text-sm text-gray-700">
                            ...
                            per diner minimum spend. Booking fees do not apply
                            towards restaurant bill.
                        </span>
                    </label>
                </div>
                        ...
                        <span class="ml-2 text-sm text-gray-700">
                            ...
                            >
                                <span class="font-semibold">
                                    I understand that this fee is for a prime
                                    time reservation and is not applied towards
                                    my bill at the restaurant.
                                </span>
                            </template>
                            <template v-else>
                                I am booking a real reservation and will arrive
                                within 15 minutes of the reserved time.
                            </template>
                        </span>
                    </label>
                </div>
        ...
        >
            ...
            <div class="relative w-full max-w-md rounded-lg bg-white p-6">
                ...
                <p class="mb-4 text-sm text-gray-600">
                    You already have a non-prime reservation for this day.
                    Please let us know why you're trying to make another
                    reservation and our team will review your request.
                </p>
                <textarea
